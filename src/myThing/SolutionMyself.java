...
//*************************链表篇******************************************
    ...
    public Solution.ListNode reverseList(Solution.ListNode head) {
        ...
        while (current != null) {
            //score
            Solution.ListNode next = current.next;
            current.next = pre;
            //准备下一轮
            pre = current;
            current = next;
    ...
    public Solution.ListNode getIntersectionListNode(Solution.ListNode headA, Solution.ListNode headB) {
        HashSet<Solution.ListNode> visited = new HashSet<Solution.ListNode>();
    ...
    public Solution.ListNode sortList(Solution.ListNode head) {
